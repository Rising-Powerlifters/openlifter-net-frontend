      ...
      <tr>
        ...
        <td>
          <ValidatedInput
            ...
            placeholder={
              hasSquat ? getString('weigh-ins.squat-rack-placeholder', language) : undefined
            }
            disabled={!hasSquat}
        ...
        <td>
          <ValidatedInput
            ...
            placeholder={
              hasBench ? getString('weigh-ins.bench-rack-placeholder', language) : undefined
            }
            disabled={!hasBench}
            validate={this.validateRack}
        ...
        <td>
          <WeightInput
            ...
            attemptOneIndexed={1}
            placeholder={
              hasDeadlift ? getString('weigh-ins.deadlift-placeholder', language) : undefined
            }
