...
class LiftingFooter extends React.Component<Props> {
  ...
  render() {
    ...
    if (flightOptions.length === 0) {
      flightOptions.push(
        <option key="none">{getString('lifting.footer-no-flights', language)}</option>
      )
    }
    ...
    const currentEntryId =
      this.props.currentEntryId === null ? undefined : this.props.currentEntryId.toString()
        ...
        <div className={styles.rightControls}>
          <ButtonGroup>
            <Button variant="outline-primary" onClick={this.props.toggleReplaceTableWithWeighins}>
              <FormattedMessage
                id="lifting.button-toggle-weigh-ins"
                defaultMessage="Toggle Weigh-ins"
              />
            </Button>
            <Button
            ...
            >
              <FormattedMessage
                id="lifting.button-toggle-fullscreen"
