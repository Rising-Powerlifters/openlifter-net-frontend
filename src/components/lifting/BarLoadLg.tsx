...
import styles from './BarLoadLg.module.scss'
...
const BarLoadLg: React.FC<Props> = ({ lift, loading, inKg, language, rackInfo }) => (
...
export default connect(mapStateToProps)(BarLoadLg)
