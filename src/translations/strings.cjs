...
strings = strings.concat([
  {
    id: 'error.invalid-openlifter',
    defaultMessage: "That didn't look like a valid OpenLifter file!"
  },
  {
    id: 'error.csv-unknown-header',
    defaultMessage:
      "Unknown header {name} in column {ABC}. Here's a list of all accepted column names: {validList}."
  },
  {
  ...
  {
    id: 'error.csv-day-platform-order',
    defaultMessage: 'The {day} column must precede the {platform} column.'
  },
  {
    id: 'error.csv-field-prefix',
    defaultMessage: "Invalid {cellType} '{cellValue}' in row {rowNumber}: "
  },
  ...
  {
    id: 'error.csv-field-suffix-day-overflow',
    defaultMessage: 'the Meet Setup page specifices only {numDays} days.'
  },
  {
  ...
  {
    id: 'error.csv-field-suffix-sex-invalid',
    defaultMessage: 'valid sexes are {M}, {F}, and {Mx}.'
  },
  {
  ...
  {
    id: 'error.csv-field-suffix-division-blank',
    defaultMessage: 'the first division is mandatory.'
  },
  {
    id: 'error.csv-field-suffix-division-invalid',
    defaultMessage: 'not a valid division per the Meet Setup page.'
  },
  {
  ...
  {
    id: 'error.csv-field-empty-or-positive',
    defaultMessage: 'expected an empty cell or a positive integer.'
  },
  {
    id: 'error.csv-field-unknown-boolean',
    defaultMessage: "expected '{Yes}', '{No}', or a blank field."
  },
  ...
  },
  {
    ...
    defaultMessage:
      'The selected file does not have any lifting data for Day {day} Platform {platform}.'
  },
...
strings = strings.concat([
  ...
  {
    id: 'meet-setup.bar-weight-deadlift-lbs',
    defaultMessage: 'Deadlift Bar + Collars weight (lbs)'
  },
  ...
  {
    id: 'meet-setup.label-also-show-kilograms',
    defaultMessage: 'Also show attempts in kilograms?'
  },
  ...
  {
    id: 'meet-setup.placeholder-classes',
    defaultMessage: 'Type a weight class and press Enter...'
  },
...
strings = strings.concat([
  ...
  {
    id: 'results.platform-export-filename',
    defaultMessage: '{meetName}-Day-{day}-Platform-{platform}'
  },
